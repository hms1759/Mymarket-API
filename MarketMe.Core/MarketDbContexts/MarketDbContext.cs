...
using MarketMe.Share.Map;
using MarketMe.Share.Timing;
...
namespace MarketMe.Core.MarketDbContexts
{
    ...
    public class MarketDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.ApplyConfiguration(new IposRoleClaimMap());
            //modelBuilder.ApplyConfiguration(new IposRoleMap());
            //modelBuilder.ApplyConfiguration(new IposUserMap());
            //modelBuilder.ApplyConfiguration(new IposUserRoleMap());
            //modelBuilder.ApplyConfiguration(new IposUserLoginMap());
            //modelBuilder.ApplyConfiguration(new IposUserTokenMap());
            //modelBuilder.ApplyConfiguration(new IposUserClaimMap());
        ...
        protected virtual TEntity AttachEntityToContext<TEntity>(TEntity entity) where TEntity : class, IEntity, new()
        {
        ...
        public IList<TEntity> ExecuteStoredProcedureList<TEntity>(string commandText, params object[] parameters) where TEntity : class, IEntity, new()
        {
