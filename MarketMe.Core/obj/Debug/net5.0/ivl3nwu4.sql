...
CREATE TABLE [MarketmeRoleClaims] (
    ...
    CONSTRAINT [FK_MarketmeRoleClaims_MarketmeRoles_RoleId] FOREIGN KEY ([RoleId]) REFERENCES [MarketmeRoles] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [MarketmeUserClaims] (
    ...
    CONSTRAINT [FK_MarketmeUserClaims_MarketmeUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [MarketmeUsers] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [MarketmeUserLogins] (
    ...
    CONSTRAINT [FK_MarketmeUserLogins_MarketmeUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [MarketmeUsers] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [MarketmeUserRoles] (
    ...
    CONSTRAINT [FK_MarketmeUserRoles_MarketmeRoles_RoleId] FOREIGN KEY ([RoleId]) REFERENCES [MarketmeRoles] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_MarketmeUserRoles_MarketmeUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [MarketmeUsers] ([Id]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [MarketmeUserTokens] (
    ...
    CONSTRAINT [FK_MarketmeUserTokens_MarketmeUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [MarketmeUsers] ([Id]) ON DELETE NO ACTION
);
GO
...
VALUES (N'20220426143803_init', N'5.0.0');
GO
